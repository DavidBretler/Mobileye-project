...
def main():
    ...
    """
    default_base_train = r"C:\Users\ddkil\OneDrive\מסמכים\GitHub\mobileye-part-b-davidteam2\Data\gtFine\train"
...
def load_data():
    ...
    :return:
    """
    loaded_data = np.fromfile("../Data/gtFine/val/data.bin", dtype=np.uint8)
    loaded_labels = np.fromfile("../Data/gtFine/train/labels.bin", dtype=np.uint8)
